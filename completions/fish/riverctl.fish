...
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'increment-focused-tags' -d 'Increments the focused tags'
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'decrement-focused-tags' -d 'Decrements the focused tags'
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'increment-view-tags'    -d 'Increments the view tags'
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'decrement-view-tags'    -d 'Decrements the view tags'
# Mappings
