...
const command_impls = std.ComptimeStringMap(
    *const fn (*Seat, []const [:0]const u8, *?[]const u8) Error!void,
    .{
        ...
        .{ "decrement-focused-tags",    @import("command/tags-increment.zig").decrementFocusedTags },
        .{ "decrement-view-tags",       @import("command/tags-increment.zig").decrementViewTags },
        ...
        .{ "increment-focused-tags",    @import("command/tags-increment.zig").incrementFocusedTags },
        .{ "increment-view-tags",       @import("command/tags-increment.zig").incrementViewTags },
